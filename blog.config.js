...
const BLOG = {
  NOTION_PAGE_ID:
    ...
    '175a0a9b2ff180d28857cf9ba0e25010,en:175a0a9b2ff180d28857cf9ba0e25010',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Roger Luo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'anchor, chain, accessory', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://anchorchain.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'anchor, chain, accessory', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Find all types of anchors, anchor chains, chains, and accessories in one place.',
